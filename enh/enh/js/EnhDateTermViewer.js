function EnhDateTermViewer(parent, style) {
	this.style = style || {};
...
EnhDateTermViewer.prototype.setFormat = function(format) {
	this.format = format;
}
EnhDateTermViewer.prototype.setValue = function(value) {
...
EnhDateTermViewer.prototype.getValue = function() {
	var value = new Array();
