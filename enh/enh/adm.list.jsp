...
JSV.Block(function () {
	...
	t.setDataUrl('/jsl/EnhAdmin.ListByUser.json', 'ts');
	...
	var del = new KButton(t.layout.titleRight, <fmt:message key="btn.pub.delete"/>);
	del.onclick = function(){
		if (BooleanFieldEditor.isChecked('id')) {
			...
			t.action.setRedirect(JSV.setUrlAlert('/enh/adm.list.jsp'),'<fmt:message key="pub.004"/>');
			t.submit('/jsl/EnhAdmin.DoDeleteByAdmin.jsl');		
		} else {
